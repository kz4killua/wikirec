      ...
      <header className="w-full h-20 px-7 flex items-center justify-between rounded-xl bg-white shadow-lg border-2 border-blue-500">
        ...
        >
          <div className="flex items-center justify-center group">
            ...
            <span className="hidden sm:block mr-1">View Github</span>
            <ArrowRight className="hidden sm:block transition-transform duration-300 ease-in-out group-hover:translate-x-1" size={16} />
          </div>
        </Link>
      </header>
    </Container>
